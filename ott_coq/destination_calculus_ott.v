...
Inductive term : Type :=  (*r Term *)
 ...
 | term_UpdA (t:term) (x:var) (t':term) (*r UpdA over the right side of ampar *)
...
with term_cshift (te : term) (H : hnames) (h' : hname) : term :=
  ...
  | term_UpdA t x t' => term_UpdA (term_cshift t H h') x (term_cshift t' H h')
...
with Ty_term : ctx -> term -> type -> Prop :=    (* defn Ty_term *)
 ...
 | Ty_term_UpdA : forall (P1 P2:ctx) (t:term) (x:var) (t':term) (U T' T:type)
     ...
     Ty_term  (union  P1   P2 )  (term_UpdA t x t') (type_Ampar U T')
 ...
 | Ty_term_NewA : forall (P:ctx) (T:type)
     (DisposP: DisposableOnly P ),
     Ty_term P term_NewA (type_Ampar T (type_Dest T  (Some (pair   Lin     (Fin 0)  )) ))
...
with Ty_ectxs : ctx -> ectxs -> type -> type -> Prop :=    (* defn Ty_ectxs *)
 ...
 | Ty_ectxs_UpdA : forall (D1:ctx) (C:ectxs) (x:var) (t':term) (U T U0:type) (D2:ctx) (T':type)
     (DisjointD1D2: D1 # D2 )
     (DestOnlyD1: DestOnly D1 )
     (DestOnlyD2: DestOnly D2 )
     (ValidOnlyD2: ValidOnly D2 )
     ...
     Ty_ectxs D1  (cons   (ectx_UpdA x t')    C )   (type_Ampar U T)  U0
...
Inductive Sem : ectxs -> term -> ectxs -> term -> Prop :=    (* defn Sem *)
 | App_Focus1 : forall (C:ectxs) (t' t:term)
     (NotValt: NotVal t ),
     Sem C (term_App t' t)   (cons   (ectx_App1 t')    C )   t
 | App_Unfocus1 : forall (C:ectxs) (t':term) (v:val),
     Sem   (cons   (ectx_App1 t')    C )   (term_Val v) C (term_App t' (term_Val v))
 | App_Focus2 : forall (C:ectxs) (t':term) (v:val)
     (NotValtp: NotVal t' ),
     Sem C (term_App t' (term_Val v))   (cons   (ectx_App2 v)    C )   t'
 | App_Unfocus2 : forall (C:ectxs) (v v':val),
     Sem   (cons   (ectx_App2 v)    C )   (term_Val v') C (term_App (term_Val v') (term_Val v))
 | App_Red : forall (C:ectxs) (x:var) (m:mode) (u:term) (v:val),
     Sem C (term_App (term_Val  (val_Fun x m u) ) (term_Val v)) C  (term_sub  u   x   v ) 
 | PatU_Focus : forall (C:ectxs) (t u:term)
     (NotValt: NotVal t ),
     Sem C (term_PatU t u)   (cons   (ectx_PatU u)    C )   t
 | PatU_Unfocus : forall (C:ectxs) (u:term) (v:val),
     Sem   (cons   (ectx_PatU u)    C )   (term_Val v) C (term_PatU (term_Val v) u)
 | PatU_Red : forall (C:ectxs) (u:term),
     Sem C (term_PatU (term_Val val_Unit) u) C u
 | PatS_Focus : forall (C:ectxs) (t:term) (m:mode) (x1:var) (u1:term) (x2:var) (u2:term)
     (NotValt: NotVal t ),
     Sem C (term_PatS t m x1 u1 x2 u2)   (cons   (ectx_PatS m x1 u1 x2 u2)    C )   t
 | PatS_Unfocus : forall (C:ectxs) (m:mode) (x1:var) (u1:term) (x2:var) (u2:term) (v:val),
     Sem   (cons   (ectx_PatS m x1 u1 x2 u2)    C )   (term_Val v) C (term_PatS (term_Val v) m x1 u1 x2 u2)
 | PatL_Red : forall (C:ectxs) (v1:val) (m:mode) (x1:var) (u1:term) (x2:var) (u2:term),
     Sem C (term_PatS (term_Val  (val_Left v1) ) m x1 u1 x2 u2) C  (term_sub  u1   x1   v1 ) 
 | PatR_Red : forall (C:ectxs) (v2:val) (m:mode) (x1:var) (u1:term) (x2:var) (u2:term),
     Sem C (term_PatS (term_Val  (val_Right v2) ) m x1 u1 x2 u2) C  (term_sub  u2   x2   v2 ) 
 | PatP_Focus : forall (C:ectxs) (t:term) (m:mode) (x1 x2:var) (u:term)
     (NotValt: NotVal t ),
     Sem C (term_PatP t m x1 x2 u)   (cons   (ectx_PatP m x1 x2 u)    C )   t
 | PatP_Unfocus : forall (C:ectxs) (m:mode) (x1 x2:var) (u:term) (v:val),
     Sem   (cons   (ectx_PatP m x1 x2 u)    C )   (term_Val v) C (term_PatP (term_Val v) m x1 x2 u)
 | PatP_Red : forall (C:ectxs) (v1 v2:val) (m:mode) (x1 x2:var) (u:term),
     Sem C (term_PatP (term_Val (val_Prod v1 v2)) m x1 x2 u) C  (term_sub   (term_sub  u   x1   v1 )    x2   v2 ) 
 | PatE_Focus : forall (C:ectxs) (t:term) (m n:mode) (x:var) (u:term)
     (NotValt: NotVal t ),
     Sem C (term_PatE t m n x u)   (cons   (ectx_PatE m n x u)    C )   t
 | PatE_Unfocus : forall (C:ectxs) (m n:mode) (x:var) (u:term) (v:val),
     Sem   (cons   (ectx_PatE m n x u)    C )   (term_Val v) C (term_PatE (term_Val v) m n x u)
 | PatE_Red : forall (C:ectxs) (n:mode) (v':val) (m:mode) (x:var) (u:term),
     Sem C (term_PatE (term_Val (val_Exp n v')) m n x u) C  (term_sub  u   x   v' ) 
 | UpdA_Focus : forall (C:ectxs) (t:term) (x:var) (t':term)
     (NotValt: NotVal t ),
     Sem C (term_UpdA t x t')   (cons   (ectx_UpdA x t')    C )   t
 | UpdA_Unfocus : forall (C:ectxs) (x:var) (t':term) (v:val),
     Sem   (cons   (ectx_UpdA x t')    C )   (term_Val v) C (term_UpdA (term_Val v) x t')
 | Ampar_Open : forall (C:ectxs) (H:hnames) (v2 v1:val) (x:var) (t':term) (h''':hname)
     (hpMaxC: h''' =  (  (hname_max   (HNames.union  H    (hnames_ectxs  C )  )  )   +   1  )  ),
     Sem C (term_UpdA (term_Val (val_Ampar H v2 v1)) x t')   (cons   (ectx_OpenAmpar  (hnames_shift  H   h''' )   (val_cshift  v2   H   h''' ) )    C )    (term_sub  t'   x    (val_cshift  v1   H   h''' )  ) 
 | Ampar_Close : forall (C:ectxs) (H:hnames) (v2 v1:val),
     Sem   (cons  (ectx_OpenAmpar H v2)   C )   (term_Val v1) C (term_Val (val_Ampar H v2 v1))
 | ToA_Focus : forall (C:ectxs) (u:term)
     (NotValu: NotVal u ),
     Sem C (term_ToA u)   (cons   ectx_ToA    C )   u
 | ToA_Unfocus : forall (C:ectxs) (v2:val),
     Sem   (cons   ectx_ToA    C )   (term_Val v2) C (term_ToA (term_Val v2))
 | ToA_Red : forall (C:ectxs) (v2:val),
     Sem C (term_ToA (term_Val v2)) C (term_Val (val_Ampar  (hnames_  nil )  v2 val_Unit))
 | FromA_Focus : forall (C:ectxs) (t:term)
     (NotValt: NotVal t ),
     Sem C (term_FromA t)   (cons   ectx_FromA    C )   t
 | FromA_Unfocus : forall (C:ectxs) (v:val),
     Sem   (cons   ectx_FromA    C )   (term_Val v) C (term_FromA (term_Val v))
 | FromA_Red : forall (C:ectxs) (v2 v1:val),
 ...
 | NewA_Red : forall (C:ectxs),
     Sem C term_NewA C (term_Val (val_Ampar  (hnames_  (cons  1  nil) )  (val_Hole  1 ) (val_Dest  1 )))
 | FillU_Focus : forall (C:ectxs) (t:term)
     (NotValt: NotVal t ),
     Sem C (term_FillU t)   (cons   ectx_FillU    C )   t
 | FillU_Unfocus : forall (C:ectxs) (v:val),
     Sem   (cons   ectx_FillU    C )   (term_Val v) C (term_FillU (term_Val v))
 | FillU_Red : forall (C:ectxs) (h:hname),
     Sem C (term_FillU (term_Val (val_Dest h)))  (ectxs_fill  C   h    (hnames_  nil )    val_Unit )  (term_Val val_Unit)
 | FillL_Focus : forall (C:ectxs) (t:term)
     (NotValt: NotVal t ),
     Sem C (term_FillL t)   (cons   ectx_FillL    C )   t
 | FillL_Unfocus : forall (C:ectxs) (v:val),
     Sem   (cons   ectx_FillL    C )   (term_Val v) C (term_FillL (term_Val v))
 | FillL_Red : forall (C:ectxs) (h h':hname)
