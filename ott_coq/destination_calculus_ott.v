...
Inductive TyR_val : ctx -> val -> type -> Prop :=    (* defn TyR_val *)
 ...
 | TyR_val_D : forall (G:ctx) (h:hdn) (T:type) (n:mode),
     ctx_Compatible G (bndr_Dest  (pair  h  (tyb_Dest   (Some (pair   Lin     (Fin 0)  ))    T   n )) )  ->
...
with Ty_term : ctx -> term -> type -> Prop :=    (* defn Ty_term *)
 ...
 | Ty_term_Var : forall (P:ctx) (x:var) (T:type),
     ctx_Compatible P (bndr_Var  (pair  x  (tyb_Var   (Some (pair   Lin     (Fin 0)  ))    T )) )  ->
 ...
 | Ty_term_PatS : forall (m:mode) (P1 P2:ctx) (t:term) (x1:var) (u1:term) (x2:var) (u2:term) (U T1 T2:type)
     ...
     ctx_Disjoint P2  (ctx_Maps (nmap_from_pair   (pair  x1  (tyb_Var  m   T1 ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   ->
     ctx_Disjoint P2  (ctx_Maps (nmap_from_pair   (pair  x2  (tyb_Var  m   T2 ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   ->
 ...
 | Ty_term_PatP : forall (m:mode) (P1 P2:ctx) (t:term) (x1 x2:var) (u:term) (U T1 T2:type)
     ...
     ctx_Disjoint P2  (ctx_Maps (nmap_from_pair   (pair  x1  (tyb_Var  m   T1 ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   ->
     ctx_Disjoint P2  (ctx_Maps (nmap_from_pair   (pair  x2  (tyb_Var  m   T2 ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   ->
     ctx_Disjoint  (ctx_Maps (nmap_from_pair   (pair  x1  (tyb_Var  m   T1 ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   (ctx_Maps (nmap_from_pair   (pair  x2  (tyb_Var  m   T2 ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   ->
 ...
 | Ty_term_PatE : forall (m:mode) (P1 P2:ctx) (t:term) (n:mode) (x:var) (u:term) (U T:type)
     ...
     ctx_Disjoint P2  (ctx_Maps (nmap_from_pair   (pair  x  (tyb_Var   (mode_times'  ((app (cons m nil) (app (cons n nil) nil))) )    T ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   ->
 ...
 | Ty_term_Map : forall (P1 P2:ctx) (t:term) (x:var) (u:term) (T1 U T2:type)
     ...
     ctx_Disjoint P2  (ctx_Maps (nmap_from_pair   (pair  x  (tyb_Var   (Some (pair   Lin     (Fin 0)  ))    T2 ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   ->
 ...
 | Ty_term_FillF : forall (P1:ctx) (n:mode) (P2:ctx) (t:term) (x:var) (m:mode) (u:term) (T1 T2:type)
     ...
     ctx_Disjoint P2  (ctx_Maps (nmap_from_pair   (pair  x  (tyb_Var  m   T1 ))  ) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   ->
...
with Ty_ectxs : ctx -> ectxs -> type -> type -> Prop :=    (* defn Ty_ectxs *)
 | TyR_ectx_Id : forall (U0:type),
     Ty_ectxs  (ctx_Maps (NmapM.empty tyb_var) (NmapM.empty tyb_dest) (NmapM.empty tyb_hole))   nil  U0 U0
 | TyR_ectx_AppFoc1 : forall (D1:ctx) (C:ectxs) (u:term) (T1 U0:type) (D2:ctx) (m:mode) (T2:type)
 ...
 | TyR_ectx_AppFoc2 : forall (D2:ctx) (C:ectxs) (v:val) (T1:type) (m:mode) (T2 U0:type) (D1:ctx)
     (TYC: Ty_ectxs  (ctx_union   (ctx_stimes  m   D1 )    D2 )  C T2 U0)
     (TYv: Ty_term D1 (term_Val v) T1),
     ctx_Disjoint D1 D2  ->
     ctx_DestOnly D1  ->
     ctx_DestOnly D2  ->
     ctx_IsValid  (ctx_stimes  m   D1 )   ->
     Ty_ectxs D2  (cons   (ectx_AppFoc2 v)    C )   (type_F T1 m T2)  U0
 | TyR_ectx_PatUFoc : forall (D1:ctx) (C:ectxs) (u:term) (U0:type) (D2:ctx) (U:type)
 ...
 | TyR_ectx_PatSFoc : forall (D1:ctx) (C:ectxs) (m:mode) (x1:var) (u1:term) (x2:var) (u2:term) (T1 T2 U0:type) (D2:ctx) (U:type)
     ...
     ctx_Disjoint D1 D2  ->
     ctx_DestOnly D1 /\ ctx_DestOnly D2  ->
     mode_IsValid m  ->
     ctx_IsValid D2  ->
     Ty_ectxs D1  (cons   (ectx_PatSFoc m x1 u1 x2 u2)    C )   (type_S T1 T2)  U0
 | TyR_ectx_PatPFoc : forall (D1:ctx) (C:ectxs) (m:mode) (x1 x2:var) (u:term) (T1 T2 U0:type) (D2:ctx) (U:type)
     (TYC: Ty_ectxs  (ctx_union   (ctx_stimes  m   D1 )    D2 )  C U U0)
 ...
 | TyR_ectx_PatEFoc : forall (D1:ctx) (C:ectxs) (m m':mode) (x:var) (u:term) (T U0:type) (D2:ctx) (U:type)
     (TYC: Ty_ectxs  (ctx_union   (ctx_stimes  m   D1 )    D2 )  C U U0)
 ...
 | TyR_ectx_MapFoc : forall (D1:ctx) (C:ectxs) (x:var) (u:term) (T1 T2 U0:type) (D2:ctx) (U:type)
     (TYC: Ty_ectxs  (ctx_union  D1   D2 )  C U U0)
 ...
 | TyR_ectx_FillFFoc : forall (D1:ctx) (C:ectxs) (x:var) (m:mode) (u:term) (T1 T2:type) (n:mode) (U0:type) (D2:ctx)
     ...
     ctx_DestOnly D1  ->
     ctx_DestOnly D2  ->
     ctx_IsValid  (ctx_stimes    (mode_times'  ((app (cons  (Some (pair   Lin     (Fin 1)  ))  nil) (app (cons n nil) nil))) )     D2 )   ->
     Ty_ectxs D1  (cons   (ectx_FillFFoc x m u)    C )  (type_D (type_F T1 m T2) n) U0
 | TyR_ectx_FillCFoc1 : forall (D1:ctx) (C:ectxs) (u:term) (T1:type) (n:mode) (U0:type) (D2:ctx) (T2:type)
 ...
 | TyR_ectx_FillCFoc2 : forall (D2:ctx) (C:ectxs) (v:val) (T1 T2 U0:type) (D1:ctx) (n:mode)
     (TYC: Ty_ectxs  (ctx_union  D1    (ctx_stimes    (mode_times'  ((app (cons  (Some (pair   Lin     (Fin 1)  ))  nil) (app (cons n nil) nil))) )     D2 )  )  C T2 U0)
     ...
     ctx_DestOnly D2  ->
     ctx_IsValid D1  ->
     mode_IsValid   (mode_times'  ((app (cons  (Some (pair   Lin     (Fin 1)  ))  nil) (app (cons n nil) nil))) )    ->
     Ty_ectxs D2  (cons   (ectx_FillCFoc2 v)    C )  (type_A T1 T2) U0
 | TyR_ectx_AOpenFoc : forall (D2 D3:ctx) (C:ectxs) (v1:val) (U U0:type) (D1:ctx) (T1:type)
     (TYC: Ty_ectxs  (ctx_union  D1   D2 )  C  (type_A T1 U)  U0)
     (TYRv1: TyR_val  (ctx_union  D1    (ctx_minus  D3 )  )  v1 T1),
     ctx_Disjoint D1 D2 /\ ctx_Disjoint D1 D3  ->
     hdns_Disjoint  (hdns_from_ectxs  C )   (hdns_from_ctx   (ctx_minus  D3 )  )   ->
     ctx_DestOnly D1 /\ ctx_DestOnly D2  ->
     ctx_DestOnly D3 /\ ctx_LinOnly D3  ->
     ctx_IsValid D1  ->
...
with Ty_eterm : ectxs -> term -> type -> Prop :=    (* defn Ty_eterm *)
 | Ty_eterm_ClosedEterm : forall (C:ectxs) (t:term) (U0:type) (G:ctx) (T:type)
     (TYRC: Ty_ectxs G C T U0)
     (TYt: Ty_term G t T),
     ctx_IsValid G  ->
     Ty_eterm C t U0.
(** definitions *)
...
Inductive Sem_eterm : ectxs -> term -> ectxs -> term -> Prop :=    (* defn Sem_eterm *)
 ...
 | Sem_eterm_MapRedAOpenFoc : forall (C:ectxs) (H:hdns) (v1 v2:val) (x:var) (u:term) (h':hdn),
     h' =  (hdns_max_hnames   (hdns_from_ectxs  C )  )   ->
 ...
 | Sem_eterm_FillLRed : forall (C:ectxs) (h h':hdn),
     h' =  (hdns_max_hnames   (HdnsM.union   (hdns_from_ectxs  C )     (hdns_from_list  (cons h nil) )  )  )   ->
