...
Proof.
    ...
    - (* Sem-Map_Red_OpenAmpar_Foc *)
      ...
      assert (DestOnly (P ᴳ+ (D11 ᴳ+ D12))) as DestOnlyPuD1. { crush. }
      rewrite (nDisposable_in_DestOnly P (D11 ᴳ+ D12) DisposP DestOnlyPuD1) in *.
      assert ((D2 ᴳ+ D11) # (D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)])) as DisjointD2uD11D13. {
          {  apply Disjoint_union_l_iff. assert (HNames.Subset hnamesᴳ(D11 ᴳ+ D12 ᴳ+ D2) hnames©(C)).
            ...
            { assert (HNames.Subset hnamesᴳ(D2) hnames©(C)).
              ...
              assert (hnamesᴳ(D2) ## hnamesᴳ( D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)])).
              { unfold HDisjoint. rewrite hnames_minus_eq. rewrite total_cshift_eq. tauto. }
            ...
            { assert (HNames.Subset hnamesᴳ(D11) hnames©(C)).
              ...
              { apply cshift_by_max_impl_HDisjoint; rewrite Nat.add_comm; unfold lt, plus; apply le_n_S; tauto. }
              assert (hnamesᴳ(D11) ## hnamesᴳ( D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)])).
              { rewrite hnames_minus_eq. rewrite total_cshift_eq. tauto. }
              apply HDisjoint_to_Disjoint; crush.
            }
          } }
      assert ((¹↑ ᴳ· D11 ᴳ+ D13) ᴳ[hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)] ⊢ ᵥ₎ v1 ᵛ[hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)] : T) as Tyt1.
        { term_Val_no_dispose ((¹↑ ᴳ· D11 ᴳ+ D13) ᴳ[hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)]). apply Ty_val_cshift; trivial. apply DestOnly_cshift_iff; apply DestOnly_union_iff; split; try apply DestOnly_stimes_iff. crush. crush. }
          assert ((¹↑ ᴳ· (D2 ᴳ+ D11)) # (D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)])).
          { apply Disjoint_stimes_l_iff. assumption. }
      constructor 1 with (D := ¹↑ ᴳ· (D2 ᴳ+ D11 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)]) ᴳ+ D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)]) (T := T') (t := t' ᵗ[ x ≔ v1 ᵛ[hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)] ]); swap 3 4;
        assert (D11 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)] = D11) as D11Eq by ( apply cshift_by_Disjoint_eq; crush );
        assert (D12 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)] = D12) as D12Eq by ( apply cshift_by_Disjoint_eq; crush );
        rewrite D11Eq.
        { assert (ValidOnly (¹↑ ᴳ· (D2 ᴳ+ D11))).
          ...
          assert (ValidOnly (D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)])).
        ...
        { assert (¹↑ ᴳ· (D2 ᴳ+ D11) ᴳ+ D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)] = (¹ν ᴳ· (¹↑ ᴳ· D11 ᴳ+ D13) ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)]) ᴳ+ ¹↑ ᴳ· D2) as ctxEq.
          ...
          rewrite ctxEq.
          assert (ValidOnly ((¹↑ ᴳ· D11 ᴳ+ D13) ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ( hnames©( C)) + 1)])).
          ...
          assert (LinOnly ((¹ν ᴳ· (¹↑ ᴳ· D11 ᴳ+ D13) ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)]) ᴳ+ ¹↑ ᴳ· D2)).
          ...
          assert (FinAgeOnly ((¹ν ᴳ· (¹↑ ᴳ· D11 ᴳ+ D13) ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)]) ᴳ+ ¹↑ ᴳ· D2)).
      ...
      rewrite cshift_distrib_on_hminus_inv.
      assert (LinOnly (D11 ᴳ+ D12 ᴳ+ D2)) as LinOnlyD. { apply (Ty_ectxs_LinOnly_FinAgeOnly (D11 ᴳ+ D12 ᴳ+ D2) C (U ⧔ T') U0). tauto. }
      assert (hnames©( C) ## hnamesᴳ( ᴳ-⁻¹ D13 ᴳ[ hnamesᴳ( ᴳ-⁻¹ D13) ⩲ (maxᴴ( hnames©( C)) + 1)])) as hnamesDisjoint.
        { rewrite <- cshift_distrib_on_hminus_inv. rewrite total_cshift_eq. apply cshift_by_max_impl_HDisjoint with (h' := maxᴴ(hnames©(C)) + 1); rewrite Nat.add_comm; unfold lt, plus; apply le_n_S; reflexivity. }
      constructor 19 with (D1 := D2 ᴳ+ D11) (D3 := D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)]) (C := C) (v2 := v2 ᵛ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)]) (T' := T') (U0 := U0) (U := U) (D2 :=
      D12).
        { apply LinOnly_union_iff. rewrite <- union_associative. rewrite union_commutative. tauto. }
        {
          {  apply Disjoint_union_l_iff. assert (HNames.Subset hnamesᴳ(D11 ᴳ+ D12 ᴳ+ D2) hnames©(C)).
            ...
            { assert (HNames.Subset hnamesᴳ(D12) hnames©(C)).
              ...
              { apply cshift_by_max_impl_HDisjoint; rewrite Nat.add_comm; unfold lt, plus; apply le_n_S; tauto. }
              assert (hnamesᴳ(D12) ## hnamesᴳ( D13 ᴳ[ hnamesᴳ(ᴳ-⁻¹ D13) ⩲ (maxᴴ(hnames©(C)) + 1)])).
              { unfold HDisjoint. rewrite hnames_minus_eq. rewrite total_cshift_eq. tauto. }
    ...
    - (* Sem-OpenAmpar_Unfoc *)
      ...
      assert (D1 ᴳ+ D2 ⊢ ᵥ₎ hnamesᴳ(ᴳ-⁻¹ D3) ⟨ v2 ❟ v1 ⟩ : U ⧔ T) as TyA.
      ...
      assert (LinOnly (D1 ᴳ+ D2) /\ FinAgeOnly (D1 ᴳ+ D2)) as (LinOnlyD & FinAgeOnlyD).
        { apply (Ty_ectxs_LinOnly_FinAgeOnly (D1 ᴳ+ D2) C (U ⧔ T) U0). tauto. }
      constructor 1 with (D := (D1 ᴳ+ D2)) (T := U ⧔ T) (t := ᵥ₎ hnamesᴳ(ᴳ-⁻¹ D3) ⟨ v2 ❟ v1 ⟩). all: crush.
(*     - (* Sem-Alloc_Red *)
      inversion Tyt; subst.
    ...
    - (* Sem-ToA_Red *)
      ...
      assert (ᴳ{} ᴳ+ D2 ⊢ ᵥ₎ hnames_ nil ⟨ v2 ❟ ᵛ() ⟩ : U ⧔ ①).
        { term_Val_no_dispose (ᴳ{} ᴳ+ D2). assert (hnamesᴳ( (ᴳ-⁻¹ ᴳ{})) = hnames_ nil). { crush. } rewrite <- H. apply Ty_val_Ampar; swap 1 11; swap 2 10.
          rewrite hminus_inv_empty_eq. rewrite <- union_empty_r_eq; tauto.
    ...
    - (* Sem-FillU_Red *)
      ...
      assert (ᴳ{} ⊣ C ©️[ h ≔ hnames_ nil ‗ ᵛ()] : ① ↣ U0).
        { assert (ᴳ{} ᴳ+ ¹ν ᴳ· (ᴳ- (n ᴳ· (ᴳ-⁻¹ ᴳ{}))) = ᴳ{}) as e1. { crush. }
          rewrite <- e1.
          assert (hnamesᴳ(ᴳ-⁻¹ ᴳ{}) = hnames_ nil) as e2. { crush. }
          rewrite <- e2.
