...
Notation "'ᵛ()'" := (val_U).
Notation "'λᵛ' x ⟼ t" := (val_F x t) (at level 59, x at level 19, t at level 59, right associativity).
...
Notation "t 'ₜ;' u" := (term_PatU t u) (at level 45, left associativity, u at next level).
...
Notation "t ⨞ 'λ' x ⟼ u" := (term_FillF t x u) (at level 43, x at level 19, u at next level, left associativity).
...
Notation "G 'ᵗ⊢' j 'ː' T" := (Ty_term G j T) (at level 70, j at level 69, T at level 59, no associativity).
